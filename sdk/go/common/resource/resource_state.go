...
type State struct {
	...
	SequenceNumber          int32                 // an auto-incrementing sequence number for each time this resource gets created/replaced (0 means sequence numbers are unknown, -1 means the last replace didn't use a sequence number).
...
func NewState(t tokens.Type, urn URN, custom bool, del bool, id ID,
	...
	importID ID, sequenceNumber int32, retainOnDelete bool) *State {
